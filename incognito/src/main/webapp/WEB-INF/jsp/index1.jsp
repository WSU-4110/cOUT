    ...
    <div class="container h-100">
      <div class="row h-100 align-items-center justify-content-center text-center">
        <div class="col-lg-10 align-self-end">
          <h1 class="text-uppercase text-white font-weight-bold">Some title</h1>
        ...
        <div class="col-lg-8 align-self-baseline">
          ...
          <br><br>
          <p class="text-white-50 font-weight-light mb-5">Have an account. Login here!</p>
        </div>
      </div>
    </div>
  </header>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8 text-center">
          <h2 class="text-white mt-0">Some header/catchphrase</h2>
          <hr class="divider light my-4">
          <p class="text-white-50 mb-4">Some description of the web application</p>
