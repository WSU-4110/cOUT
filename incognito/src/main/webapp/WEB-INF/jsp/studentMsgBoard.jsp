...
<div class="container">
  <div class="card border-0 shadow my-5">
    <div class="card-body p-5">
      <h1 class="font-weight-light">Student Messaging Board</h1>
      <hr>
      ...
      <div class="split right">
	    ...
	    <p><input type="text" name = "studentMessage"> <input type= "submit"> </p>   
	   <button type="button" class="btn btn-primary btn-lg" float="right">Nudge</button>
