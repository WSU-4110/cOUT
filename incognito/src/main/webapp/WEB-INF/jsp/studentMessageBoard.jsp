...
<html>
   <head>
      <%@ page isELIgnored="false" %><%@ page language="java" contentType="text/html; charset=ISO-8859-1"
   pageEncoding="ISO-8859-1"%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<!DOCTYPE html>
<html>
         ...
         <div class="card border-0 shadow my-5">
                                 ...
                                 <c:if test="${o.is_answered == true}">
                                    <tr>
                                       <td position:absolute>
                                             <br><b><font face = "Arial">Question: ${o.QUESTION}</font></b>
                                             <br><i><font face = "Arial" color = "#f4623a">Answer: ${o.ANSWER}</font></i>                                        
                                       </td>
                                    </tr>
                                 </c:if>
                              </c:forEach>
            ...
            <div class="split right">
               <div class="centered overflow-auto center">
                  ...
                  <br>
                  <p style = "border-radius: 20px; padding: 10px; border: 2px solid #f4623a;"><i>Your Asked Questions</i></p>
                  <table align="center">
                  ...
                  <hr>
                  <p style = "border-radius: 20px; padding: 10px; border: 2px solid #f4623a;"><i>Your Unanswered Questions</i></p>
                  <br>
                  <table align = "center">
                     <c:if test="${not empty userQuestion}">
                        <c:forEach var="o" items="${userQuestion}">
                           <c:if test="${o.is_answered==false}">
                              ...
                              <div style = "border-radius: 20px; padding: 10px; border: 1px solid #f4623a;">                                                                     
                                          ...
                                          <button class="btn btn-primary btn-xs" type = "submit">NUDGE</button>
                                       </form>
                  ...
                  <button type="button" class="btn btn-primary btn-md" data-target="#askQuestion" data-toggle="collapse" >Ask a Question</button>
               
               <div id = "askQuestion" class = "collapse">
