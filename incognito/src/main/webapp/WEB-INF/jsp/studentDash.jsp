...
=======
     ...
     <td>
     	${o.crsName}
      	...
      	<button type="button" class="btn btn-primary btn-lg" data-target="#myModal" data-toggle="collapse" >Join Class</button>
	      <div id = "myModal" class = "collapse">
				      <form action= "/joinCourse" method = "POST">
				     	...
				     	<div class = "modal-body">
				     		<h5>AccessCode:</h5><input type="text" class="form-control" name="crsName" placeholder="Enter Class name" required >
				     	</div>
