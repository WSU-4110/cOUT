    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8 text-center">
          <h2 class="mt-0">Error: Account does not exist</h2>
          <hr class="divider my-4">
          <p class="text-muted mb-5">If you have created your account, check your email for confirmation. If not, you need to create an account.</p>
        </div>
      </div>
